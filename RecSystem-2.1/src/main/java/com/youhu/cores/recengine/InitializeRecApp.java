...
/**
 * @ClassName: InitializeRecApp
 * @Description: 读取数据，并针对用户数据和书籍数据进行初始化推荐，生成：书籍推荐表，好友推荐表，用户类簇推荐表，书籍类簇推荐表，
 * @author: hiwes
 * @date: 2018年5月22日
 * @version: 2.1.1
 */
public class InitializeRecApp implements Serializable {
	...
	public static void InitializeRec() throws IOException {
